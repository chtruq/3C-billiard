  ...
  return (
    ...
    >
      ...
      <View className="ml-2 w-[50vw]">
        <Text className="text-base font-psemibold pt-2">{data?.name}</Text>
        ...
        <View className="flex-row justify-between items-center pt-2">
          <View className="flex-row items-center">
            ...
            <Text className="font-pbold ml-1">{data?.star}</Text>
          </View>
          <Text className="font-pregular text-gray-500">{data?.distance}</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
